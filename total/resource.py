...
class TotalResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = ['id', 'brand', 'model', 'speed', 'condition', 'status', 'clarity_left', 'clarity_right', 'clarity',
                  'loudness_left', 'loudness_right', 'loudness', 'sharpness_left', 'sharpness_right', 'sharpness',
                  'volatility_left',
                  'volatility_right', 'volatility', 'index']
