...
class CarManger(admin.ModelAdmin):
    list_display = ['brand', 'model', 'power', 'gear']
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        return super(CarManger, self).change_view(request, object_id,
    ...
    def operate(self, obj):
        ...
        if True:
            # 编辑按钮
            data1 = '{"icon": "fas fa-user-tie","url": "/admin/car/car/%d/change/"}' % (obj.id)
            ...
            # 删除按钮
            data2 = '{"icon": "fas fa-user-tie","url": "/car/single_delete/%d"}' % (obj.id)
            ...
            html_str = f"<div>您无权操作</div>"

        return mark_safe(html_str)


admin.site.register(Car, CarManger)
admin.site.site_header = '通过噪声数据库系统'
