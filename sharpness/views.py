...
def delete_true_view(request, duty_id):
    ...
    if request.method == 'GET':
        ...
        try:
            print("delete_true_view")
            print(duty_id)
            obj = Sharpness.objects.get(id=duty_id)
...
def get_image(request, id):
    ...
    if request.method == 'GET':
        ...
        try:
            obj = Sharpness.objects.get(id=id).total
            url = MEDIA_URL + str(obj.sharpness_image)
            dataname = '尖锐度'
...
def analyse(request, ids):
    ...
    for id in id_list:
        sharpness = Sharpness.objects.get(id=id).total
        categories.append(
            str(str(sharpness.speed) + '/' + str(sharpness.condition) + '/' + str(sharpness.status) + '/' + str(
                sharpness.car.brand) + '/' + str(sharpness.car.model)))
        y[str(sharpness.status)].append(
            str(str(sharpness.speed) + '/' + str(sharpness.condition) + '/' + str(sharpness.status) + '/' + str(
                sharpness.car.brand) + '/' + str(sharpness.car.model)) + '/' + str(
                sharpness.sharpness_left) + '/' + str(sharpness.sharpness_right))
        flag = True
        ...
        sharpness_left.append(sharpness.sharpness_left)
        sharpness_right.append(sharpness.sharpness_right)
    ...
    for id in id_list:
        ...
        categories.append(
            str(str(sharpness.speed) + '/' + temp + '/' + str(sharpness.status) + '/' + str(
                sharpness.car.brand) + '/' + str(sharpness.car.model) + '/' + str(sharpness.sharpness_left) + '/' + str(
                sharpness.sharpness_right)))
